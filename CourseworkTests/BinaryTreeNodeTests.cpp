...
public:
	...
	TEST_METHOD(IsLeaf_NoChildren_ReturnTrue)
	{
		string value = "Test";
	...
	TEST_METHOD(IsLeaf_OneChildLeft_ReturnFalse)
	{
		string value = "Test";
	...
	TEST_METHOD(IsLeaf_OneChildRight_ReturnFalse)
	{
		string value = "Test";
	...
	TEST_METHOD(IsLeaf_TwoChildren_ReturnFalse)
	{
		string value = "Test";
	...
	TEST_METHOD(HasOnlyOneChild_NoChildren_ReturnNull)
	{
		string value = "Test";
	...
	TEST_METHOD(HasOnlyOneChild_OneChildLeft_ReturnLeft)
	{
		string value = "Test";
	...
	TEST_METHOD(HasOnlyOneChild_OneChildRight_ReturnRight)
	{
		string value = "Test";
	...
	TEST_METHOD(HasOnlyOneChild_TwoChildren_ReturnNull)
	{
		string value = "Test";
